...
namespace sp {
	...
	struct Texture {
		...
		void BindImageConvert(GLuint binding, GLPixelFormat bindFormat, GLenum access, GLint level = 0,
			GLboolean layered = false, GLint layer = 0) const;
		...
		Texture &Image2D(const void *pixels, GLint level = 0, GLsizei subWidth = 0, GLsizei subHeight = 0,
			GLsizei xoffset = 0, GLsizei yoffset = 0, bool genMipmap = true);
		Texture &Image3D(const void *pixels, GLint level = 0, GLsizei subWidth = 0, GLsizei subHeight = 0,
			GLsizei subDepth = 0, GLsizei xoffset = 0, GLsizei yoffset = 0, GLsizei zoffset = 0, bool genMipmap = true);
		Texture &GenMipmap();
