...
namespace ecs {
    ...
    void Scripts::OnTickParallel(Lock<WriteAll> lock, chrono_clock::duration interval) {
        Assertf(lock.entity.has_value(), "Scripts::OnTickParallel requires an entity lock");
