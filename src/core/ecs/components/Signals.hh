...
namespace ecs {
    ...
    static const StructMetadata MetadataSignalOutput(typeid(SignalOutput), StructField::New(&SignalOutput::signals));
    ...
    static const StructMetadata MetadataSignalBindings(typeid(SignalBindings),
