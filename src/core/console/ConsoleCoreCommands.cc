...
namespace sp {
    ...
    void ConsoleManager::RegisterCoreCommands() {
        ...
        funcs.Register<uint64, string>("wait",
        ...
        funcs.Register<ecs::FocusLayer>("acquirefocus",
        ...
        funcs.Register<ecs::FocusLayer>("releasefocus",
        ...
        funcs.Register<string>("clearsignal",
