...
//     Assertf(ctx != nullptr, "sp_get_signal_ref called with null game ctx");
...
//     Assertf(ctx != nullptr, "sp_get_signal called with null game ctx");
...
//     Assertf(ctx != nullptr, "sp_set_signal called with null game ctx");
