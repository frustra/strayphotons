...
namespace sp {
    namespace xr {
        ...
        // This class contains tracking functionality for the HMD, eye position, and any arbitrary "tracked objects"
        // exposed by the XR Runtime. Conceptually, this means it must:
