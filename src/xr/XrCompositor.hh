...
namespace sp
{
	...
	namespace xr
	{
		...
		public:
			...
			// doing Mixed Reality Capture. The Boolean input "Minimum" asks the XR System for the absolute, bare-minimum
			// number of eye views required to render correctly. This is useful on performance-constrained systems.
		...
		protected:
			// Only XrCompositor is a friend of RenderTarget, so XrCompositor must provide standardized functions for manipulating the texture
			// inside the RenderTarget on behalf of the derived class.
			// You could override this.. but it wouldn't really get you anywhere.
